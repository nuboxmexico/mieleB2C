jQuery(function($) {
  ...
  sidebar_toggle.on('click', function() {
    ...
    var mainWrapperCollapsedClasses = 'col-xs-12 col-md-12 col-md-offset-0 sidebar-collapsed';
...
$(document).ready(function(){
  ...
  $('body').on('click', '.delete-resource', function(e) {
    ...
    e.preventDefault();
      swal({
          title: '¿Esta seguro?',
          html: '<div class="swal2-custom-content">No podrá recuperarlo</div>',
          type: 'warning',
          ...
          if (result.value) {
              swal({
                type: 'success',
                title: '¡Eliminado!',
                html: '<div class="swal2-custom-content">El recurso ya no esta disponible</div>',
              })
              $.ajax({
                type: 'POST',
                url: $(this).prop("href"),
            ...
            swal({
              type: 'error',
              title: 'Cancelado',
              html: '<div class="swal2-custom-content">Ha mantenido el recurso disponible</div>',
            })
          }
        })
