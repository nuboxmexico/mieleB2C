...
SitemapGenerator::Sitemap.create do
  ...
  #   end
  add_login({ host: Spree::Store.default.url })
  add_signup({ host: Spree::Store.default.url })
  add_account({ host: Spree::Store.default.url })
  add_password_reset({ host: Spree::Store.default.url })
  add_taxons({ host: Spree::Store.default.url })
  add_products({ host: Spree::Store.default.url })
end
